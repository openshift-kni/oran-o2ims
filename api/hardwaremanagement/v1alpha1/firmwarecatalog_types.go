...
// ImageValidationStatus reports the validation result for a single image entry.
...
// +operator-sdk:csv:customresourcedefinitions:displayName="Firmware Catalog",resources={{ConfigMap, v1}}
