...
//+kubebuilder:rbac:groups=ocloud.openshift.io,namespace=system,resources=inventories,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=ocloud.openshift.io,namespace=system,resources=inventories/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=ocloud.openshift.io,namespace=system,resources=inventories/finalizers,verbs=update
