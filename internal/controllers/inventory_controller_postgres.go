...
func (t *reconcilerTask) deployPostgresServer(ctx context.Context, serverName string) error {
	...
	pvc := &corev1.PersistentVolumeClaim{
		...
		Spec: corev1.PersistentVolumeClaimSpec{
			...
			StorageClassName: k8sptr.To("standard"),
	...
	t.logger.DebugContext(ctx, "[deployPostgresServer] Create/Update PVC", "Name", pvcName)
	if err := ctlrutils.CreateK8sCR(ctx, t.client, pvc, t.object, ctlrutils.UPDATE); err != nil {
