...
func (t *clusterTemplateReconcilerTask) run(ctx context.Context) (ctrl.Result, error) {
	...
	if t.object.Spec.TemplateID == "" {
		...
		err := generateTemplateID(ctx, t.logger, t.client, t.object)
		if err != nil {
...
func (t *clusterTemplateReconcilerTask) validateConfigmapReference(
	...
	if existingConfigmap.Immutable != nil && !*existingConfigmap.Immutable {
		...
		if err := ctlrutils.CreateK8sCR(ctx, t.logger, t.client, newConfigmap, nil, ctlrutils.PATCH); err != nil {
...
// If the templateID does not exist, it is generated by this function using uuid
func generateTemplateID(ctx context.Context, logger *slog.Logger, c client.Client, object *provisioningv1alpha1.ClusterTemplate) error {
	if object.Spec.TemplateID != "" {
		return nil
	}
	newID := uuid.New()
	...
	err := ctlrutils.CreateK8sCR(ctx, logger, c, newTemplate, nil, ctlrutils.PATCH)
	if err != nil {
