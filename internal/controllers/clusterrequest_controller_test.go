...
func createNode(name, bmcAddress, bmcSecret, mac, groupName string, namespace string, npName string) *hwv1alpha1.Node {
...
func verifyNodeStatus(c client.Client, ctx context.Context, nodes []*hwv1alpha1.Node, mhost string, whost string) {
	for _, node := range nodes {
