...
type ManagedInfrastructureTemplate struct {
	...
	//
	//
	// Example: {"deploymentType":"sno","networkType":"ran"}
	...
	//
	//
	// Example: {"properties":{"clusterInstanceParameters":{"type":"object"},"nodeClusterName":{"type":"string"},"oCloudSiteId":{"type":"string"},"policyTemplateParameters":{"type":"object"}},"required":["nodeClusterName","oCloudSiteId","policyTemplateParameters","clusterInstanceParameters"]}
	ParameterSchema map[string]interface{} `json:"parameterSchema"`

	// Version Example: v4-17-3-1
...
func (siw *ServerInterfaceWrapper) GetManagedInfrastructureTemplate(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "managedInfrastructureTemplateId", r.PathValue("managedInfrastructureTemplateId"), &managedInfrastructureTemplateId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
