...
func (d *ACMDataSource) convertNodeToResource(from data.Object) (to models.Resource, err error) {
	slog.Debug("converting node to resource", "from", from)
...
func (d *ACMDataSource) convertClusterToResourcePool(from data.Object) (to models.ResourcePool, err error) {
	slog.Debug("converting cluster to resource pool", "from", from)
...
func (d *ACMDataSource) getDeploymentManagerExtensions(ctx context.Context, clusterName string) (map[string]string, error) {
