-- Drop the trigger for setting object_type_id in alarm_definition
DROP TRIGGER IF EXISTS populate_alarm_definition_object_type_id ON alarm_definition;

-- Drop the trigger function for setting object_type_id in alarm_definition
DROP FUNCTION IF EXISTS set_alarm_definition_object_type_id;
