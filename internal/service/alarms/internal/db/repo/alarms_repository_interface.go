...
type AlarmRepositoryInterface interface {
	...
	UpsertAlarmEventRecord(ctx context.Context, records []models.AlarmEventRecord, globalCloudID uuid.UUID) error
	...
	ClaimDataChangeEvent(ctx context.Context) ([]commonmodels.DataChangeEvent, error)
}
