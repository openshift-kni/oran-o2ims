...
func (siw *ServerInterfaceWrapper) DeleteSubscription(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "alarmSubscriptionId", r.PathValue("alarmSubscriptionId"), &alarmSubscriptionId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid", ValueIsUnescaped: true})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetAlarm(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "alarmEventRecordId", r.PathValue("alarmEventRecordId"), &alarmEventRecordId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "uuid", ValueIsUnescaped: true})
	if err != nil {
...
type CallbackReceiverInterface interface {
	...
	// HandleOnAlarmEventCallback handles the POST callback for onAlarmEvent.
	HandleOnAlarmEventCallback(w http.ResponseWriter, r *http.Request)
}
...
// OnAlarmEventCallbackHandler returns the http.Handler for the onAlarmEvent callback.
...
func OnAlarmEventCallbackHandler(si CallbackReceiverInterface, errHandler func(w http.ResponseWriter, r *http.Request, err error), middlewares ...CallbackReceiverMiddlewareFunc) http.Handler {
	if errHandler == nil {
	...
	var h http.Handler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		si.HandleOnAlarmEventCallback(w, r)
	})
