...
func (siw *ServerInterfaceWrapper) ProvisioningRequestCallback(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "provisioningRequestName", r.PathValue("provisioningRequestName"), &provisioningRequestName, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
