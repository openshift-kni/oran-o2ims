...
`open-cluster-management-observability` namespace, as seen in [sno-ran-full-du-pg-observability-v1](./samples/git-setup/policytemplates/version_4.Y.Z/sno-ran-full-du/sno-ran-full-du-pg-observability-v1.yaml). This policy will create a
