...
* The list is available in [files folder](internal/files/alarms/definition.json). Can be customized and maintained as required. The properties are mapped as follows:
